...
export default function GlobalAudioControls() {
  ...
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[9999] flex items-center gap-3 bg-slate-900/90 backdrop-blur-md p-2.5 rounded-2xl border border-emerald-500/30 shadow-[0_10px_40px_rgba(16,185,129,0.15)] animate-in slide-in-from-bottom-10 fade-in duration-300">

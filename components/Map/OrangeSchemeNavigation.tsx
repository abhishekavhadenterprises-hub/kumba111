...
export const ORANGE_SCHEME_ROUTES = [
  ...
  "In Route Nandurbar Satana Sogras Phata Agra Mumbai - Janore Ramshej Dugaon Rohile Phaata Talwade - Trimbak",
...
const ORANGE_AUDIO_MAP: Record<string, string> = {
  ...
  "In Route Nandurbar Satana Sogras Phata Agra Mumbai - Janore Ramshej Dugaon Rohile Phaata Talwade - Trimbak": "/audio/orange nandurbar.mp3.mpeg",
